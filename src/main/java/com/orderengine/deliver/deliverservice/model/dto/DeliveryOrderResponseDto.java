...
public class DeliveryOrderResponseDto {
    ...
    public DeliveryOrderResponseDto(String userLogin, BigDecimal deliveryCost, String destination, LocalDateTime createdAt, OrderStatus orderStatus, LocalDateTime deliveredAt, String courierLogin, String courierContactInfo) {
